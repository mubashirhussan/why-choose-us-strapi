...
export interface ApiWhyChooseUsWhyChooseUs extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    Description: Schema.Attribute.Text &
      Schema.Attribute.DefaultTo<'Lorem ipsum dolor sit amet consectetur adipisicing elit...'>;
    Feature: Schema.Attribute.Component<'shared.features', true>;
    ...
    publishedAt: Schema.Attribute.DateTime;
    Title: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'We Are Different From Others'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
